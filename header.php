...
<li style="padding-top: 10px;"><img src="logof.png" alt="Logo" width="200"></li>
                                            ...
                                            <li class="nav-item"><a href="sc.php" class="nav-link"  style="color: black;font-size: 20px;padding-top: 40px;">Scores</a>
                                            </li>
                                        ...
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    <span class="admin-name"  style="color: black;font-size: 20px;padding-top: 40px;"><?php echo $_SESSION["username"]; ?></span>
                ...
                <div class="row" style="background-color: #0E57A7 ; ">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcome-list">
                            <div class="row">
                                <div class="col-lg-6" style = "font-size:20px">Welcome, <b><?php echo $_SESSION["username"]; ?></b></div>
