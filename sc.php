...
<li style="float:right; padding: 20px; margin-right: 15px;position: absolute;top: 20px; right: 60px; font-size:25px;list-style-type: none;"><a href="select_exam.php">>>Back</a></li>
</ul>
                         </div>  
<?php
session_start();
