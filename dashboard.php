...
<div class="row" style="margin: 0px; padding:0px; margin-bottom: 50px; background-image:url(back.jpg); height:550px">
            ...
            <div class="row" style="margin-top: 10px">
                ...
                <div class="col-lg-6 col-lg-push-3" style="min-height: 50px">
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <input type="button" class="btn btn-success" value="Next" onclick="nextVal();">
